...
- [API Contracts — Phase 0 + Phase 1 + Phase 2 (Overview)](./api-phase0-phase1.md)
- [Frontend — Session Start + Overview (Phase 2 state)](./frontend-session-start-overview-skeleton.md)
